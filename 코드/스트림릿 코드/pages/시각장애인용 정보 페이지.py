...
# 배경 이미지 설정
img_base64 = get_base64_of_bin_file('음성인식이미지.png')
background_image_style = f"""

<style> .stApp {{ background: url("data:image/png;base64,{img_base64}") no-repeat center center fixed; background-size: contain; /* Adjust the size of the image */ }} </style>
"""
